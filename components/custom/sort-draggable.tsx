    ...
    >
      ...
      <DropdownMenu onOpenChange={setOpen}>
        ...
        <DropdownMenuContent>
          ...
          >
            <DropdownMenuRadioItem value={"asc"} indicator={false}>
              <Button
                variant={"nothing"}
                size={"sm"}
                className="whitespace-nowrap w-full justify-between"
              >
                Ascending <ChevronsUpIcon />
              </Button>
            </DropdownMenuRadioItem>
            <DropdownMenuRadioItem value={"desc"} indicator={false}>
              <Button
                variant={"nothing"}
                size={"sm"}
                className="whitespace-nowrap w-full justify-between"
            ...
            <DropdownMenuRadioItem value={"remove"} indicator={false}>
              <Button
                variant={"destructive"}
                size={"sm"}
                className="whitespace-nowrap w-full justify-between"
